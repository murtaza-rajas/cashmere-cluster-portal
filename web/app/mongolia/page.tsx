...
import { fetchMyMongoliaStories, type MongoliaStory } from "@/lib/api";

// First real Mongolia content type: Stories & News (named first in the
// client's confirmed content list for both Mongolia levels, 2026-09-09
// email). Producer profiles, the photo archive, voting, and Mongolia
// offers are real, later pieces of this same section — not built yet.
