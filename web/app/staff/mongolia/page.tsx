...
// content: stories, news, videos, Care & Repair guides"). First real
// content type for Cashmere Lovers Club Mongolia (Stories & News) — see
// mongolia.controller.ts's comment for the rest of this section's scope.
    ...
    <div className="flex w-full flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-cashmere-text-muted">
          Stories &amp; News shown to Mongolia members. Founding-only stories are hidden from Mongolia Newsletter.
        </p>
      </div>
