...
export default function MongoliaStoriesAdminPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="font-serif text-3xl tracking-tight text-cashmere-text">Stories &amp; News</h1>
        <p className="mt-1 text-cashmere-text-muted">
          Mongolia stories, shown on the Mongolia member home. Founding-only stories are hidden from Mongolia Newsletter.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Community, Mongolia and the World"
                className="mt-1 w-full rounded-lg border border-cashmere-border px-3 py-2 text-sm"
              />
            </div>
            <div>
